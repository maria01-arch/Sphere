  ...
  return (
    <div style={{minHeight:'100vh',background:'#090B10',color:'#fff'}}>
      ...
      <div style={{padding:'0 16px 20px'}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:2}}><h2 style={{fontWeight:800,fontSize:22,margin:0}}>{currentUser?.display_name}</h2>{currentUser?.verified&&<span title='Sphere Verified Member' style={{display:'inline-flex',alignItems:'center',justifyContent:'center',width:20,height:20,borderRadius:'50%',background:'linear-gradient(135deg,#1a1a2e,#16213e)',border:'2px solid #C9A84C',boxShadow:'0 0 6px rgba(201,168,76,0.6)',flexShrink:0,cursor:'default'}}><span style={{fontFamily:'serif',fontWeight:900,fontSize:9,background:'linear-gradient(135deg,#FFD700,#C9A84C)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',letterSpacing:'-0.5px',lineHeight:1}}>SV</span></span>}{currentUser?.is_authentic&&<span style={{display:'inline-flex',width:20,height:20,flexShrink:0,cursor:'default'}}><svg title='Authentic — Real & Verified Person' xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' style={{display:'block'}}><path d='M12 1l2.8 2.4 3.6-.8 1.2 3.4 3.2 1.6-1 3.5 1 3.5-3.2 1.6-1.2 3.4-3.6-.8L12 23l-2.8-2.4-3.6.8-1.2-3.4L1.2 16.4l1-3.5-1-3.5 3.2-1.6L5.6 4.4l3.6.8z' fill='#1877F2'/><path d='M8.5 12.5l2 2 5-5' stroke='#fff' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' fill='none'/></svg></span>}</div>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:'flex',gap:6,alignItems:'center',flexWrap:'wrap',marginBottom:6,justifyContent:'space-between'}}>
            <div style={{display:'flex',gap:6,alignItems:'center'}}>
              ...
              {a.verified&&<span title='Sphere Verified Member' style={{display:'inline-flex',alignItems:'center',justifyContent:'center',width:20,height:20,borderRadius:'50%',background:'linear-gradient(135deg,#1a1a2e,#16213e)',border:'2px solid #C9A84C',boxShadow:'0 0 6px rgba(201,168,76,0.6)',flexShrink:0,cursor:'default'}}><span style={{fontFamily:'serif',fontWeight:900,fontSize:9,background:'linear-gradient(135deg,#FFD700,#C9A84C)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',letterSpacing:'-0.5px',lineHeight:1}}>SV</span></span>}{a.is_authentic&&<span style={{display:'inline-flex',width:18,height:18,flexShrink:0,cursor:'default'}}><svg title='Authentic — Real & Verified Person' xmlns='http://www.w3.org/2000/svg' width='18' height='18' viewBox='0 0 24 24' style={{display:'block'}}><path d='M12 1l2.8 2.4 3.6-.8 1.2 3.4 3.2 1.6-1 3.5 1 3.5-3.2 1.6-1.2 3.4-3.6-.8L12 23l-2.8-2.4-3.6.8-1.2-3.4L1.2 16.4l1-3.5-1-3.5 3.2-1.6L5.6 4.4l3.6.8z' fill='#1877F2'/><path d='M8.5 12.5l2 2 5-5' stroke='#fff' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' fill='none'/></svg></span>}
